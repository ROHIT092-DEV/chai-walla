...
import { ShoppingCart, ArrowRight, Play, Star, Users, Coffee, TrendingUp, Award } from 'lucide-react';
      ...
      <main className="min-h-screen bg-white pt-16 pb-20 lg:pt-20 lg:pb-0">
        ...
        <div className="relative bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-20 right-20 w-96 h-96 bg-yellow-500/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
          </div>
            ...
            <div className="text-center">
              ...
              >
                ...
                <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                  Discover the finest collection of authentic teas, carefully sourced and delivered fresh to your doorstep. Experience the perfect brew every time.
                </p>
                
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                  <button 
                    onClick={() => router.push('/products')}
                    className="group bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700 text-white px-10 py-5 rounded-2xl font-bold text-xl transition-all duration-300 shadow-2xl hover:shadow-orange-500/25 transform hover:-translate-y-1 flex items-center justify-center space-x-3"
                  >
                    <span>Shop Now</span>
                    <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                  </button>
                  
                  <button className="group bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white px-10 py-5 rounded-2xl font-bold text-xl transition-all duration-300 hover:border-white/40 flex items-center justify-center space-x-3">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
                  ...
                  >
                    <div className="text-4xl lg:text-5xl font-black text-orange-400 mb-2">{dashboardData.stats.totalUsers}+</div>
                    <div className="text-gray-300 text-sm lg:text-base">Happy Customers</div>
                    <div className="text-green-400 text-xs mt-1">{dashboardData.growth.users} this month</div>
                  </motion.div>
                  ...
                  >
                    <div className="text-4xl lg:text-5xl font-black text-yellow-400 mb-2">{dashboardData.stats.totalOrders}+</div>
                    <div className="text-gray-300 text-sm lg:text-base">Orders Delivered</div>
                    <div className="text-green-400 text-xs mt-1">{dashboardData.growth.orders} this month</div>
                  </motion.div>
                  ...
                  >
                    <div className="text-4xl lg:text-5xl font-black text-pink-400 mb-2">{dashboardData.stats.averageRating.toFixed(1)}★</div>
                    <div className="text-gray-300 text-sm lg:text-base">Customer Rating</div>
                    <div className="text-yellow-400 text-xs mt-1">5-star reviews</div>
                  </motion.div>
                  ...
                  >
                    <div className="text-4xl lg:text-5xl font-black text-green-400 mb-2">{dashboardData.stats.totalProducts}+</div>
                    <div className="text-gray-300 text-sm lg:text-base">Tea Varieties</div>
                    <div className="text-green-400 text-xs mt-1">Premium quality</div>
                  </motion.div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Experience the difference with our premium quality, authentic flavors, and exceptional service
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">Hand-picked tea leaves from the finest gardens, ensuring exceptional taste and aroma in every cup</p>
                <div className="text-orange-600 font-semibold">100% Authentic • Fresh Daily</div>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 mb-6">Quick and reliable delivery service ensuring your tea reaches you fresh and on time</p>
                <div className="text-green-600 font-semibold">Same Day • Free Shipping</div>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 mb-6">Dedicated support team to help you choose the perfect tea and ensure complete satisfaction</p>
                <div className="text-blue-600 font-semibold">24/7 Support • Expert Advice</div>
              </motion.div>
            </div>
          </div>
        </div>
              ...
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    "Amazing quality tea! The flavor is incredible and delivery was super fast. Will definitely order again!"
                  </p>
        ...
        <div className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Discover our most popular tea varieties loved by thousands of customers
              </p>
            </div>
